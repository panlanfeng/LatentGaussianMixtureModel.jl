...
@everywhere function Brun(b::Integer, Ctrue::Integer, Calternative::Integer; debuginfo::Bool=false, ntrials::Int=25, Xstd::Real=1.0)
    n = 500
    srand(100)
    ...
    X, Y, groupindex, wi_true, mu_true, sigmas_true, betas_true, m, gamma_true = datagen(n, Ctrue, N, J, n_ij, b=b, adjustmean=false, showpower=showpower, Xstd=Xstd)
